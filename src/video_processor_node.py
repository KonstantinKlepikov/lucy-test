...
class LucyEditProAPINode:
    ...
    def process_video(self, images, prompt, api_key, fps):
        ...
        """
        output_images, output_fps = utils.generate_edited_video_tensor(
            images, prompt, api_key, fps
        )
...
class LucyConditionConcatNode:
    ...
    def apply_concat(self, model, concat_latent):
        ...
        # Create a wrapper function that will handle the concatenation during
        # the diffusion steps
            ...
            if x.shape[0] != concat_tensor.shape[0]:
                if concat_tensor.shape[0] == 1:
                    ...
                    raise ValueError(
                        ...
                        f' {concat_tensor.shape[0]} != {x.shape[0]}'
                    )
